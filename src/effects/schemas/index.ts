...
const _WrappedEffectThreatPower = BaseEffectSchema.extend({ type: z.literal(CONSTS.EFFECT_THREAT_POWER), data: EffectThreatPower });
...
const _WrappedEffectImmunity = BaseEffectSchema.extend({ type: z.literal(CONSTS.EFFECT_IMMUNITY), data: EffectImmunity });
...
export const EffectSchema = z.discriminatedUnion('type', [
    ...
    _WrappedEffectThreatPower,
    _WrappedEffectCharm,
    _WrappedEffectDisease,
    _WrappedEffectFear,
    _WrappedEffectImmunity,
