...
export const PropertySchemaRegeneration = z.strictObject({
    ...
    amp: z.number().int(), // normal amount of hp regain per turn
    ...
    shutdown: z.number().int().optional(), // This is a working property, if > 0, regeneration will stop until this value is soaked down
