...
export { PropertyDamageImmunity } from './damage/damage-immunity';
export { PropertyDamageModifier } from './damage/damage-modifier';
export { PropertyDamageReduction } from './damage/damage-reduction';
export { PropertyDamageResistance } from './damage/damage-resistance';
export { PropertyDamageVulnerability } from './damage/damage-vulnerability';
export { PropertyHealingFactor } from './healing/healing-factor';
export { PropertyHealingModifier } from './healing/healing-modifier';
export { PropertyRegeneration } from './healing/regeneration';
export { PropertyCursed } from './items/cursed';
export { PropertyExtraWeaponDamageType } from './items/extra-weapon-damage-type';
export { PropertyUnidentified } from './items/unidentified';
export { PropertyWeightFactor } from './items/weight-factor';
export { PropertyAbilityCheckModifier } from './modifiers/ability-check-modifier';
export { PropertyAbilityModifier } from './modifiers/ability-modifier';
export { PropertyAbilityResistanceModifier } from './modifiers/ability-resistance-modifier';
export { PropertyArmorClassModifier } from './modifiers/armor-class-modifier';
export { PropertyAttackModifier } from './modifiers/attack-modifier';
export { PropertyExtraHitpoints } from './modifiers/extra-hitpoints';
export { PropertySkillModifier } from './modifiers/skill-modifier';
export { PropertyImmunity } from './status/immunity';
export { PropertyDarkvision } from './visibility/darkvision';
export { PropertyLight } from './visibility/light';
