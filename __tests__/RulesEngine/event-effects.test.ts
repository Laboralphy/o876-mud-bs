...
describe('RulesEngine — effect events', () => {
    ...
    describe('EVENT_EFFECT_PROCESSOR_EFFECT_APPLIED', () => {
        it('fires when an effect is applied to a creature', () => {
            ...
            creature.applyEffect(
                { type: CONSTS.EFFECT_ABILITY_MODIFIER, amp: 2, ability: CONSTS.ABILITY_BODY },
                source,
                5
            );
    ...
    describe('EVENT_EFFECT_PROCESSOR_EFFECT_IMMUNITY', () => {
        it('fires on every applyEffect call regardless of immunity status', () => {
            ...
            creature.applyEffect(
                { type: CONSTS.EFFECT_ABILITY_MODIFIER, amp: 1, ability: CONSTS.ABILITY_BODY },
                source,
                5
            );
            expect(spy).toHaveBeenCalledOnce();
        ...
        it('payload includes an immune callback that overrides immunity when called', () => {
            ...
            creature.applyEffect(
                { type: CONSTS.EFFECT_ABILITY_MODIFIER, amp: 5, ability: CONSTS.ABILITY_BODY },
                source,
                5
            );
